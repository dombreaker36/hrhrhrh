...
router.post("/",checkAuth, validate.questionValidation, controllers.createQuestion);
...
router.post("/:id/answers",checkAuth, validate.createAnswer, controllers.createAnswer);
